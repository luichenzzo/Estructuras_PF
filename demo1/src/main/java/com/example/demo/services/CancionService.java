...
public class CancionService {
     ...
     * @throws com.example.demo.exceptions.RecursoNoEncontradoException Si no existe la canción
     */
    public Cancion actualizarCancion(String id, CancionRegistroPorNombreDTO cancionDTO) {
        ...
        if (cancionOpt.isEmpty()) {
            throw new com.example.demo.exceptions.RecursoNoEncontradoException("No se encontró la canción con ID: " + id);
        }
