...
import com.example.demo.exceptions.ArtistaNoEncontradoException;
import com.example.demo.exceptions.AlbumNoEncontradoException;
...
public class AlbumService {
     ...
     * @throws com.example.demo.exceptions.RecursoNoEncontradoException Si no existe el álbum
     */
    public Album actualizarAlbum(String id, AlbumRegistroPorNombreDTO albumDTO) {
        ...
        if (albumOpt.isEmpty()) {
            throw new com.example.demo.exceptions.RecursoNoEncontradoException("No se encontró el álbum con ID: " + id);
        }
        ...
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(archivo.getInputStream()))) {
            ...
            while ((linea = reader.readLine()) != null) {
                ...
                try {
                    ...
                    com.example.demo.model.GENERO genero = null;
                    try {
                        genero = com.example.demo.model.GENERO.valueOf(campos[3].trim().toUpperCase());
