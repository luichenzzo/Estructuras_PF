...
/**
 * Implementación de una Lista Circular (Redonda)
...
public class ListaRedonda<T> implements Lista<T> {
    ...
    /**
     * Rota la lista hacia adelante (la cabeza se convierte en cola)
     */
    ...
    /**
     * Rota la lista hacia atrás (la cola se convierte en cabeza)
     */
    ...
    /**
     * Iterador para recorrer la lista circular
    ...
    /**
     * Crea un iterador infinito que recorre la lista continuamente
     */
