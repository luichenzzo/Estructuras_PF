...
/**
 * Implementación de un Grafo No Dirigido (sin pesos)
 * Usado para el módulo de red social de usuarios (RF-023)
...
public class GrafoNoDirigido<T> implements IGrafo<T> {
    ...
    /**
     * Obtiene los vecinos directos de un vértice como Set
     * @param vertice El vértice
     * @return Set con los vecinos directos
     */
    ...
    /**
     * Implementación de BFS (Búsqueda en Amplitud) para encontrar "amigos de amigos"
     * Usado para RF-024: Sugerencias de usuarios
     * @param origen Vértice de origen
     * @param profundidad Nivel de profundidad (2 para amigos de amigos)
     * @return Lista de usuarios encontrados a la profundidad especificada
     */
    ...
    /**
     * BFS general que retorna todos los vértices alcanzables
     * @param origen Vértice de origen
     * @return Lista de todos los vértices alcanzables desde el origen
     */
    ...
    /**
     * Encuentra amigos de amigos que no son amigos directos (para sugerencias)
